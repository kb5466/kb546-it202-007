...
<tr><td> <em>Generated: </em> 10/8/2023 4:08:58 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-007-F23/init-db-setup/grade/kb546" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fkb546%2F2023-10-08T19.50.47Screenshot%202023-10-08%20154542.png.webp?alt=media&token=f799a600-a040-41f9-a632-4f048a7fc894"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the table made and including the url on heroku dev<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fkb546%2F2023-10-08T19.52.40Screenshot%202023-10-08%20155225.png.webp?alt=media&token=ff8c853b-d103-4bc3-be3d-f6d38a276a6f"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the table made in vscode including my ucid<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned what a simple sql table would require to make one and<br>using the init db I can see how it interacts with html<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I had an issue where I couldnt find the init db file after<br>deploying ProjectSetup. I fixed it by add/commit/push into github so that the heroku<br>could recognize it.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link (ProjectSetup to Dev)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/kb5466/kb546-it202-007/pull/9">https://github.com/kb5466/kb546-it202-007/pull/9</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://it202-kb546-prod-e32002342896.herokuapp.com/project/sql/init_db.php">https://it202-kb546-prod-e32002342896.herokuapp.com/project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-007-F23/init-db-setup/grade/kb546" target="_blank">Grading</a></td></tr></table>
