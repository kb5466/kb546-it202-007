...
<tr><td> <em>Generated: </em> 10/3/2023 10:37:23 PM</td></tr>
...
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fkb546%2F2023-10-04T02.33.28Screenshot%202023-10-03%20223206.png.webp?alt=media&token=ee05e938-9895-4b4d-a6ef-38a6d6199035"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing what happens when profile is click, title of tab changes to login<br>and h1 shows login<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fkb546%2F2023-10-04T02.33.31Screenshot%202023-10-03%20223213.png.webp?alt=media&token=2fd511ac-88d5-4837-8cac-372923b94255"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing what happens when logout is click, title of tab changes to login<br>and h1 shows login<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>since the navigation bar was surrounded by the nav tag, I just used<br>selectors using nav and changing its list style type to none so instead<br>of doing the defaul vertically, it changes to none which is just horizontal<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>for the nav bar, it happened automatically when I changed the list style<br>type to none but for the other list i just changed it to<br>list-style none as well so it would keep its list like feature<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>using selectors I used a nav selector and changed its background color to<br>blue<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>initially, I used selectors which made it very easy but I used query<br>selector which selected all the items on the list, after getting all of<br>it I made functions color_on and color_off which when paired with eventlisteners on<br>mouseover and mouseout it would change the link&#39;s background color to either black<br>or none.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I used the selectors h3+ul because I noticed the lists are after the<br>h3 tag then nested it with the li tag and used ::before and<br>put the checkmark inside. The bullet points disappeared when I made the list-style<br>into none and the check mark was added before the contents<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I used the capitalize function for the selector h1 and a. It works<br>because the function capitalizes the first word.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I changed the background color of the page to green<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>on the h3+ul i changed the background color to gray, the navigation list<br>doesnt get affected because i used the h3 selector which excludes the prior<br>nav list and only change the lists afterwards.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I made an update_pg function which takes the text content of the link<br>clicked and sets the h1 text to the link text.&nbsp;<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I made an update_pg function which takes the text content of the link<br>clicked and also sets the document title to the link text.&nbsp;<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I struggled to figure out the js version of changing the background color<br>of the link when it hovers over it. But in css hover makes<br>it 100x easier.<br></p><br></td></tr>
